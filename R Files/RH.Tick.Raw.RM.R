...
fitted_data.host.climate.leporispalustris.raw$Combo <- with(fitted_data.host.climate.leporispalustris.raw, paste(Host, Climate, sep = ", "))
fitted_data.host.climate.leporispalustris.raw$Combo <- factor(fitted_data.host.climate.leporispalustris.raw$Combo, levels = c("One, Tropical", 
...
p.host.climate.leporispalustris.raw <- ggplot() +
  ...
  geom_line(data = fitted_data.host.climate.leporispalustris.raw, aes(x = Temperature, y = Fitted, color = Combo), size = 1) +
...
# Combine Climate and Size for coloring
fitted_data.host.climate.aegyptium.raw$Combo <- with(fitted_data.host.climate.aegyptium.raw, paste(Host, Climate, sep = ", "))
fitted_data.host.climate.aegyptium.raw$Combo <- factor(fitted_data.host.climate.aegyptium.raw$Combo, levels = c("One, Tropical", 
                                                                                                                              "Two, Subtropical", "Three, Mixed",
                                                                                                                              "Three, Subtropical", "Three, Temperate",
                                                                                                                              "Three, Tropical"))
...
p.host.climate.aegyptium.raw <- ggplot() +
  geom_point(data = plot_data.host.climate.raw, aes(x = Temperature, y = Trait), alpha = 0.5) +
  geom_line(data = fitted_data.host.climate.aegyptium.raw, aes(x = Temperature, y = Fitted, color = Combo), size = 1) +
  labs(title = "Observed Data and Quadratic Fit by Host and Climate",
       x = "Temperature", y = "Oviposition Time in Days") +
  theme_minimal() +
  facet_wrap(~ Species) 
...
# Combine Climate and Size for coloring
fitted_data.host.climate.dromedarii.raw$Combo <- with(fitted_data.host.climate.dromedarii.raw, paste(Host, Climate, sep = ", "))
fitted_data.host.climate.dromedarii.raw$Combo <- factor(fitted_data.host.climate.dromedarii.raw$Combo, levels = c("One, Tropical", 
                                                                                                                              "Two, Subtropical", "Three, Mixed",
                                                                                                                              "Three, Subtropical", "Three, Temperate",
                                                                                                                              "Three, Tropical"))
...
p.host.climate.dromedarii.raw <- ggplot() +
  geom_point(data = plot_data.host.climate.raw, aes(x = Temperature, y = Trait), alpha = 0.5) +
  geom_line(data = fitted_data.host.climate.dromedarii.raw, aes(x = Temperature, y = Fitted, color = Combo), size = 1) +
  labs(title = "Observed Data and Quadratic Fit by Host and Climate",
       x = "Temperature", y = "Oviposition Time in Days") +
  theme_minimal() +
  facet_wrap(~ Species) 
...
# Combine Climate and Size for coloring
fitted_data.host.climate.impeltatum.raw$Combo <- with(fitted_data.host.climate.impeltatum.raw, paste(Host, Climate, sep = ", "))
fitted_data.host.climate.impeltatum.raw$Combo <- factor(fitted_data.host.climate.impeltatum.raw$Combo, levels = c("One, Tropical", 
                                                                                                                              "Two, Subtropical", "Three, Mixed",
                                                                                                                              "Three, Subtropical", "Three, Temperate",
                                                                                                                              "Three, Tropical"))
...
p.host.climate.impeltatum.raw <- ggplot() +
  geom_point(data = plot_data.host.climate.raw, aes(x = Temperature, y = Trait), alpha = 0.5) +
  geom_line(data = fitted_data.host.climate.impeltatum.raw, aes(x = Temperature, y = Fitted, color = Combo), size = 1) +
  labs(title = "Observed Data and Quadratic Fit by Host and Climate",
       x = "Temperature", y = "Oviposition Time in Days") +
  theme_minimal() +
  facet_wrap(~ Species) 
...
# Combine Climate and Size for coloring
fitted_data.host.climate.lusitanicum.raw$Combo <- with(fitted_data.host.climate.lusitanicum.raw, paste(Host, Climate, sep = ", "))
fitted_data.host.climate.lusitanicum.raw$Combo <- factor(fitted_data.host.climate.lusitanicum.raw$Combo, levels = c("One, Tropical", 
                                                                                                                              "Two, Subtropical", "Three, Mixed",
                                                                                                                              "Three, Subtropical", "Three, Temperate",
                                                                                                                              "Three, Tropical"))
...
p.host.climate.lusitanicum.raw <- ggplot() +
  geom_point(data = plot_data.host.climate.raw, aes(x = Temperature, y = Trait), alpha = 0.5) +
  geom_line(data = fitted_data.host.climate.lusitanicum.raw, aes(x = Temperature, y = Fitted, color = Combo), size = 1) +
  labs(title = "Observed Data and Quadratic Fit by Host and Climate",
       x = "Temperature", y = "Oviposition Time in Days") +
  theme_minimal() +
  facet_wrap(~ Species) 
...
# Combine Climate and Size for coloring
fitted_data.host.climate.schulzei.raw$Combo <- with(fitted_data.host.climate.schulzei.raw, paste(Host, Climate, sep = ", "))
fitted_data.host.climate.schulzei.raw$Combo <- factor(fitted_data.host.climate.schulzei.raw$Combo, levels = c("One, Tropical", 
                                                                                                                              "Two, Subtropical", "Three, Mixed",
                                                                                                                              "Three, Subtropical", "Three, Temperate",
                                                                                                                              "Three, Tropical"))
...
p.host.climate.schulzei.raw <- ggplot() +
  geom_point(data = plot_data.host.climate.raw, aes(x = Temperature, y = Trait), alpha = 0.5) +
  geom_line(data = fitted_data.host.climate.schulzei.raw, aes(x = Temperature, y = Fitted, color = Combo), size = 1) +
  labs(title = "Observed Data and Quadratic Fit by Host and Climate",
       x = "Temperature", y = "Oviposition Time in Days") +
  theme_minimal() +
  facet_wrap(~ Species) 
...
fitted_data.h.c.g.aegyptium.raw$Combo <- with(fitted_data.h.c.g.aegyptium.raw, paste(Host, Climate, Genus, sep = ", "))

# Plot observed data and fitted curves with facet wrap by species
p.h.c.g.aegyptium.raw <- ggplot() +
  geom_point(data = plot_data.h.c.g.raw, aes(x = Temperature, y = Trait), alpha = 0.5) +
  geom_line(data = fitted_data.h.c.g.aegyptium.raw, aes(x = Temperature, y = Fitted, color = Combo), size = 1) +
...
# Combine Host, Climate, and Size for coloring
fitted_data.h.c.g.dromedarii.raw$Combo <- with(fitted_data.h.c.g.dromedarii.raw, paste(Host, Climate, Genus, sep = ", "))

# Plot observed data and fitted curves with facet wrap by species
p.h.c.g.dromedarii.raw <- ggplot() +
  geom_point(data = plot_data.h.c.g.raw, aes(x = Temperature, y = Trait), alpha = 0.5) +
  geom_line(data = fitted_data.h.c.g.dromedarii.raw, aes(x = Temperature, y = Fitted, color = Combo), size = 1) +
  labs(title = "Observed Data and Quadratic Fit by Host, Climate, and Genus",
       x = "Temperature", y = "Oviposition Time in Days") +
  theme_minimal() +
  facet_wrap(~ Species) 
...
# Combine Host, Climate, and Size for coloring
fitted_data.h.c.g.lusitanicum.raw$Combo <- with(fitted_data.h.c.g.lusitanicum.raw, paste(Host, Climate, Genus, sep = ", "))

# Plot observed data and fitted curves with facet wrap by species
p.h.c.g.lusitanicum.raw <- ggplot() +
  geom_point(data = plot_data.h.c.g.raw, aes(x = Temperature, y = Trait), alpha = 0.5) +
  geom_line(data = fitted_data.h.c.g.lusitanicum.raw, aes(x = Temperature, y = Fitted, color = Combo), size = 1) +
  labs(title = "Observed Data and Quadratic Fit by Host, Climate, and Genus",
       x = "Temperature", y = "Oviposition Time in Days") +
  theme_minimal() +
  facet_wrap(~ Species) 
...
# Combine Host, Climate, and Size for coloring
fitted_data.h.c.g.schulzei.raw$Combo <- with(fitted_data.h.c.g.schulzei.raw, paste(Host, Climate, Genus, sep = ", "))

# Plot observed data and fitted curves with facet wrap by species
p.h.c.g.schulzei.raw <- ggplot() +
  geom_point(data = plot_data.h.c.g.raw, aes(x = Temperature, y = Trait), alpha = 0.5) +
  geom_line(data = fitted_data.h.c.g.schulzei.raw, aes(x = Temperature, y = Fitted, color = Combo), size = 1) +
  labs(title = "Observed Data and Quadratic Fit by Host, Climate, and Genus",
       x = "Temperature", y = "Oviposition Time in Days") +
  theme_minimal() +
  facet_wrap(~ Species) 
