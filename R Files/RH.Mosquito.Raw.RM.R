...
p.climate.aegypti <- ggplot() +
  ...
  labs(title = "Development Time in Days by Climate",
...
m.fitted_data.climate.size.aegypti$Combo <- with(m.fitted_data.climate.size.aegypti, paste(Climate, Size, sep = ", "))
m.fitted_data.climate.size.aegypti$Combo <- factor(m.fitted_data.climate.size.aegypti$Combo, levels = c("temperate, large", 
...
p.climate.size.aegypti <- ggplot() +
  ...
  geom_line(data = m.fitted_data.climate.size.aegypti, aes(x = Temperature, y = Fitted, color = Combo), size = 1) +
  labs(
    title = "Development Time in Days by Climate and Size",
    x = "Temperature",
    y = "Trait Value",
...
# Combine Climate and Size for coloring
m.fitted_data.climate.size.atropalpus$Combo <- with(m.fitted_data.climate.size.atropalpus, paste(Climate, Size, sep = ", "))
m.fitted_data.climate.size.atropalpus$Combo <- factor(m.fitted_data.climate.size.atropalpus$Combo, levels = c("temperate, large", 
                                                                                                        "subtropical, medium", "subtropical, large",
                                                                                                        "tropical, small", "tropical, medium"))
# Plot observed data and fitted curves with facet wrap by species
p.climate.size.atropalpus <- ggplot() +
  geom_point(data = m.plot_data.climate.size, aes(x = Temperature, y = Trait), alpha = 0.5) +
  geom_line(data = m.fitted_data.climate.size.atropalpus, aes(x = Temperature, y = Fitted, color = Combo), size = 1) +
  labs(
    title = "Development Time in Days by Climate and Size",
    x = "Temperature",
    y = "Trait Value",
...
# Combine Climate and Size for coloring
m.fitted_data.climate.size.jj$Combo <- with(m.fitted_data.climate.size.jj, paste(Climate, Size, sep = ", "))
m.fitted_data.climate.size.jj$Combo <- factor(m.fitted_data.climate.size.jj$Combo, levels = c("temperate, large", 
                                                                                                        "subtropical, medium", "subtropical, large",
                                                                                                        "tropical, small", "tropical, medium"))
# Plot observed data and fitted curves with facet wrap by species
p.climate.size.jj <- ggplot() +
  geom_point(data = m.plot_data.climate.size, aes(x = Temperature, y = Trait), alpha = 0.5) +
  geom_line(data = m.fitted_data.climate.size.jj, aes(x = Temperature, y = Fitted, color = Combo), size = 1) +
  labs(
    title = "Development Time in Days by Climate and Size",
    x = "Temperature",
    y = "Trait Value",
...
# Combine Climate and Size for coloring
m.fitted_data.climate.size.krombeini$Combo <- with(m.fitted_data.climate.size.krombeini, paste(Climate, Size, sep = ", "))
m.fitted_data.climate.size.krombeini$Combo <- factor(m.fitted_data.climate.size.krombeini$Combo, levels = c("temperate, large", 
                                                                                                        "subtropical, medium", "subtropical, large",
                                                                                                        "tropical, small", "tropical, medium"))
# Plot observed data and fitted curves with facet wrap by species
p.climate.size.krombeini <- ggplot() +
  geom_point(data = m.plot_data.climate.size, aes(x = Temperature, y = Trait), alpha = 0.5) +
  geom_line(data = m.fitted_data.climate.size.krombeini, aes(x = Temperature, y = Fitted, color = Combo), size = 1) +
  labs(
    title = "Development Time in Days by Climate and Size",
    x = "Temperature",
    y = "Trait Value",
