...
fitted_data.host.climate.leporispalustris$Combo <- with(fitted_data.host.climate.leporispalustris, paste(Host, Climate, sep = ", "))
fitted_data.host.climate.leporispalustris$Combo <- factor(fitted_data.host.climate.leporispalustris$Combo, levels = c("One, Tropical", 
...
p.host.climate.leporispalustris <- ggplot() +
  ...
  geom_line(data = fitted_data.host.climate.leporispalustris, aes(x = Temperature, y = Fitted, color = Combo), size = 1) +
...
# Combine Climate and Size for coloring
fitted_data.host.climate.aegyptium$Combo <- with(fitted_data.host.climate.aegyptium, paste(Host, Climate, sep = ", "))
fitted_data.host.climate.aegyptium$Combo <- factor(fitted_data.host.climate.aegyptium$Combo, levels = c("One, Tropical", 
                                                                                                        "Two, Subtropical", "Three, Mixed",
                                                                                                        "Three, Subtropical", "Three, Temperate",
                                                                                                        "Three, Tropical"))
...
p.host.climate.aegyptium <- ggplot() +
  geom_point(data = plot_data.host.climate, aes(x = Temperature, y = Trait), alpha = 0.5) +
  geom_line(data = fitted_data.host.climate.aegyptium, aes(x = Temperature, y = Fitted, color = Combo), size = 1) +
  labs(title = "Observed Data and Quadratic Fit by Host and Climate",
       x = "Temperature", y = "Trait Value") +
  theme_minimal() +
  facet_wrap(~ Species) 
...
# Combine Climate and Size for coloring
fitted_data.host.climate.dromedarii$Combo <- with(fitted_data.host.climate.dromedarii, paste(Host, Climate, sep = ", "))
fitted_data.host.climate.dromedarii$Combo <- factor(fitted_data.host.climate.dromedarii$Combo, levels = c("One, Tropical", 
                                                                                                          "Two, Subtropical", "Three, Mixed",
                                                                                                          "Three, Subtropical", "Three, Temperate",
                                                                                                          "Three, Tropical"))
...
p.host.climate.dromedarii <- ggplot() +
  geom_point(data = plot_data.host.climate, aes(x = Temperature, y = Trait), alpha = 0.5) +
  geom_line(data = fitted_data.host.climate.dromedarii, aes(x = Temperature, y = Fitted, color = Combo), size = 1) +
  labs(title = "Observed Data and Quadratic Fit by Host and Climate",
       x = "Temperature", y = "Trait Value") +
  theme_minimal() +
  facet_wrap(~ Species) 
...
# Combine Climate and Size for coloring
fitted_data.host.climate.impeltatum$Combo <- with(fitted_data.host.climate.impeltatum, paste(Host, Climate, sep = ", "))
fitted_data.host.climate.impeltatum$Combo <- factor(fitted_data.host.climate.impeltatum$Combo, levels = c("One, Tropical", 
                                                                                                          "Two, Subtropical", "Three, Mixed",
                                                                                                          "Three, Subtropical", "Three, Temperate",
                                                                                                          "Three, Tropical"))
...
p.host.climate.impeltatum <- ggplot() +
  geom_point(data = plot_data.host.climate, aes(x = Temperature, y = Trait), alpha = 0.5) +
  geom_line(data = fitted_data.host.climate.impeltatum, aes(x = Temperature, y = Fitted, color = Combo), size = 1) +
  labs(title = "Observed Data and Quadratic Fit by Host and Climate",
       x = "Temperature", y = "Trait Value") +
  theme_minimal() +
  facet_wrap(~ Species) 
...
# Combine Climate and Size for coloring
fitted_data.host.climate.lusitanicum$Combo <- with(fitted_data.host.climate.lusitanicum, paste(Host, Climate, sep = ", "))
fitted_data.host.climate.lusitanicum$Combo <- factor(fitted_data.host.climate.lusitanicum$Combo, levels = c("One, Tropical", 
                                                                                                            "Two, Subtropical", "Three, Mixed",
                                                                                                            "Three, Subtropical", "Three, Temperate",
                                                                                                            "Three, Tropical"))
...
p.host.climate.lusitanicum <- ggplot() +
  geom_point(data = plot_data.host.climate, aes(x = Temperature, y = Trait), alpha = 0.5) +
  geom_line(data = fitted_data.host.climate.lusitanicum, aes(x = Temperature, y = Fitted, color = Combo), size = 1) +
  labs(title = "Observed Data and Quadratic Fit by Host and Climate",
       x = "Temperature", y = "Trait Value") +
  theme_minimal() +
  facet_wrap(~ Species) 
...
# Combine Climate and Size for coloring
fitted_data.host.climate.schulzei$Combo <- with(fitted_data.host.climate.schulzei, paste(Host, Climate, sep = ", "))
fitted_data.host.climate.schulzei$Combo <- factor(fitted_data.host.climate.schulzei$Combo, levels = c("One, Tropical", 
                                                                                                      "Two, Subtropical", "Three, Mixed",
                                                                                                      "Three, Subtropical", "Three, Temperate",
                                                                                                      "Three, Tropical"))
...
p.host.climate.schulzei <- ggplot() +
  geom_point(data = plot_data.host.climate, aes(x = Temperature, y = Trait), alpha = 0.5) +
  geom_line(data = fitted_data.host.climate.schulzei, aes(x = Temperature, y = Fitted, color = Combo), size = 1) +
  labs(title = "Observed Data and Quadratic Fit by Host and Climate",
       x = "Temperature", y = "Trait Value") +
  theme_minimal() +
  facet_wrap(~ Species) 
...
fitted_data.h.c.g.aegyptium$Combo <- with(fitted_data.h.c.g.aegyptium, paste(Host, Climate, Genus, sep = ", "))

# Plot observed data and fitted curves with facet wrap by species
p.h.c.g.aegyptium <- ggplot() +
  geom_point(data = plot_data.h.c.g, aes(x = Temperature, y = Trait), alpha = 0.5) +
  geom_line(data = fitted_data.h.c.g.aegyptium, aes(x = Temperature, y = Fitted, color = Combo), size = 1) +
...
# Combine Host, Climate, and Size for coloring
fitted_data.h.c.g.dromedarii$Combo <- with(fitted_data.h.c.g.dromedarii, paste(Host, Climate, Genus, sep = ", "))

# Plot observed data and fitted curves with facet wrap by species
p.h.c.g.dromedarii <- ggplot() +
  geom_point(data = plot_data.h.c.g, aes(x = Temperature, y = Trait), alpha = 0.5) +
  geom_line(data = fitted_data.h.c.g.dromedarii, aes(x = Temperature, y = Fitted, color = Combo), size = 1) +
  labs(x = "Temperature", y = "Oviposition in Days") +
  theme_minimal() +
  facet_wrap(~ Species) 
p.h.c.g.dromedarii
...
# Combine Host, Climate, and Size for coloring
fitted_data.h.c.g.lusitanicum$Combo <- with(fitted_data.h.c.g.lusitanicum, paste(Host, Climate, Genus, sep = ", "))

# Plot observed data and fitted curves with facet wrap by species
p.h.c.g.lusitanicum <- ggplot() +
  geom_point(data = plot_data.h.c.g, aes(x = Temperature, y = Trait), alpha = 0.5) +
  geom_line(data = fitted_data.h.c.g.lusitanicum, aes(x = Temperature, y = Fitted, color = Combo), size = 1) +
  labs(x = "Temperature", y = "Oviposition in Days") +
  theme_minimal() +
  facet_wrap(~ Species) 
p.h.c.g.lusitanicum
...
# Combine all individual data frames into one
fitted_data.h.c.g.schulzei <- do.call(rbind, fitted_list)
...
# Combine Host, Climate, and Size for coloring
fitted_data.h.c.g.schulzei$Combo <- with(fitted_data.h.c.g.schulzei, paste(Host, Climate, Genus, sep = ", "))

# Plot observed data and fitted curves with facet wrap by species
p.h.c.g.schulzei <- ggplot() +
  geom_point(data = plot_data.h.c.g, aes(x = Temperature, y = Trait), alpha = 0.5) +
  geom_line(data = fitted_data.h.c.g.schulzei, aes(x = Temperature, y = Fitted, color = Combo), size = 1) +
  labs(x = "Temperature", y = "Oviposition in Days") +
  theme_minimal() +
  facet_wrap(~ Species) 
p.h.c.g.schulzei
ggsave("tick.h.c.g.schulzei.plot.png", plot = p.h.c.g.schulzei, width = 8.5, height = 5)
...
fitted_data.host.genus.schulzei$Combo <- with(fitted_data.host.genus.schulzei, paste(Host, Genus, sep = ", "))
fitted_data.host.genus.schulzei$Combo <- factor(fitted_data.host.genus.schulzei$Combo, levels = c("One, Dermacentor", 
...
p.host.genus.schulzei <- ggplot() +
  ...
  geom_line(data = fitted_data.host.genus.schulzei, aes(x = Temperature, y = Fitted, color = Combo), size = 1) +
...
# Combine Climate and Size for coloring
fitted_data.genus.climate.schulzei$Combo <- with(fitted_data.genus.climate.schulzei, paste(Genus, Climate, sep = ", "))


# Plot observed data and fitted curves with facet wrap by species
p.genus.climate.schulzei <- ggplot() +
  geom_point(data = plot_data.genus.climate, aes(x = Temperature, y = Trait), alpha = 0.5) +
  geom_line(data = fitted_data.genus.climate.schulzei, aes(x = Temperature, y = Fitted, color = Combo), size = 1) +
